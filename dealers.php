...
<div class="container-fluid">
 ...
 <div class="col-lg-6">
  <ul class="list-inline" style="text-align: right;">
    <li><button onclick="location.href = './adddealer.php';" type="button" id="addrecord" class="btn btns pull-left">Add Dealer <i class="fas fa-user-plus btnicons"></i></button></li>
 ...
 <div class="col-lg-12">
  ...
  <thead>
    <tr >
      ...
      <th>District<span class='sorticon'><i class="fas fa-sort"></i></span></th>
  ...
  <tbody>
    ...
    while($i<$count){
     ...
     <tr>
      ...
      <td><?php echo( $product_data[$i]["district"]) ?></td>
