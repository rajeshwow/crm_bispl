...
if ($array=='' || $array==null) {
  ...
  $i=0;
$j=1;
$delete = "DELETE FROM tallyoutstanding_lucknow";
...
while ($i<$count){
  ...
  $sql = "INSERT INTO tallyoutstanding_lucknow(party,bill_date,pendingamount,dueon,overdueday)
