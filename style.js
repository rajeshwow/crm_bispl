   ...
   $(document).ready(function(){
      ...
      $("#advsearch").submit(function(e) {
         ...
         $.ajax({
            ...
            type:"POST",
            data: 'choosedyear='+selectedyear+'&choosedquarter='+selectedquarter,
...
$(document).ready(function(){
   ...
   $(document).ready(function(){
    ...
    if ((usernamess === "Already Exist") || (usernamess === '') || (usernamess === null) || (usernamess === undefined))
    {
      $("#newserial").focus();
      $("#newserial").attr('placeholder', 'Enter Serial no : This is mandatory field !');
      $("#newserial").attr('style', 'border:1px solid red !important');
      $("#newserial").addClass("animate__animated animate__shakeX animate__repeat-1 ");
   }
   ...
   return false;
       ...
       $("#lostandupgradeform").submit(function(e) {
         ...
         if (drpdown == '' || drpdown == null || drpdown== 'undefined' ) {
            ...
            $("#planyear").addClass("animate__animated animate__shakeX animate__repeat-1 ");
         }
         else{
           $.ajax({
