         ...
         <div class="col-lg-12">
            <div class="formbox">
               <form action="./submitrenewal.php" method="POST">
               	<h3 style="text-align: center;">Please Enter Product Details.</h3>
                  ...
                  <div class="form-group row">
                    <div class="col-xs-6">
                      <input type="text" required="ture" class="form-control "  name="serialno" id="serialno" placeholder="Purchase From">
                    </div>
                    <div class="col-xs-6">
                      <input type="date" class="form-control "  name="product_name" id="product_name" placeholder="Purchase Date">
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-4">
                      <input required="ture" type="text" class="form-control" name="dealer" id="dealer" placeholder="Enter Dealer name"></div>
                  </div>
