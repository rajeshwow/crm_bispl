                                          ...
                                          <?php if ($product_dat[0]["users_view"] == 'Yes' || ($_SESSION['usertype']=='Admin')) { ?>
                                             ...
                                             <?php } else{ ?>
                                                ...
                                                $(document).ready(function(){
                                                   ...
                                                   $("select#offsets").val(localStorage.getItem('renewalOffset'));
                                                   
                                                   $.ajax({
                                                      url:"getrenewaldata.php",
                                                      type:"POST",
                                                      data: {offsets:localStorage.getItem('renewalOffset')},
                                                      beforeSend: function(){
                                                ...
                                                $(document).ready(function(){
                                                   $("#offsets").change(function() {
                                                      renewalOffset = $(this).val();
                                                      localStorage.setItem('renewalOffset',renewalOffset)
                                                   
                                                   $.ajax({
                                                      url:"getrenewaldata.php",
                                                      type:"POST",
                                                      data: {offsets:renewalOffset},
                                                      beforeSend: function(){
                                                         $("#loadingss").show();
                                                      },
                                                      success:function(data){
