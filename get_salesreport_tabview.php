...
<?php if ($costcentre_count>0){ ?>
	...
	<?php while ($i<$costcentre_count) { 
		...
		<div class="panel">
			<br>
			<ul class="nav nav-pills nav-justified" style="border: 0px solid lightgray;border-width: 0 0 1px 1px;
			border-top-left-radius: 5px;
			border-top-right-radius: 5px;">
			<li ><a data-toggle="pill" href="#q1<?php echo ($i+1)*5?>">Q 1</a></li>
			<li class="active"><a data-toggle="pill" href="#q2<?php echo ($i+1)*5?>">Q 2</a></li>
			<li><a data-toggle="pill" href="#q3<?php echo ($i+1)*5?>">Q 3</a></li>
			<li><a data-toggle="pill" href="#q4<?php echo ($i+1)*5?>">Q 4</a></li>
		</ul>
		<br>
...
$total_monthss_1 = date("F", mktime(0, 0, 0, $total_monthss-2, 10));
$total_monthss_2 = date("F", mktime(0, 0, 0, $total_monthss-1, 10));
$total_monthss_3 = date("F", mktime(0, 0, 0, $total_monthss, 10));
$inc=5;
?>
<div id="q<?php echo $itr+1?><?php echo ($i+1)*$inc;?>" class="tab-pane fade <?php echo  $itr==1 ?'active in': ''; ?>">
			...
			<thead>
				...
				<tbody>
					<tr>
						...
						<td><?php echo $total_monthss_1?></td>
						<?php 
						$first_total = 0;
						$count_i = 0;
						...
						while($first_i<$panel_count_getcategory){
							...
							<tr>
								<td><?php echo $total_monthss_2?></td>
								<?php 
								$second_total = 0;
								$count_i2 = 0;
								...
								while($second_i<$panel_count_getcategory){
									...
									<tr>
										...
										<td><?php echo $total_monthss_3?></td>
										<?php 
										$third_total = 0;
										$count_i3 = 0;
