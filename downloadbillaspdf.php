...
<?php 
$groupdata = explode('---', $_POST['data']);
// echo $prty = $groupdata[0];
// echo $vdte = $groupdata[1];
// echo $cstcentre = $groupdata[2];
...
<script>
		...
		function CreatePDFfromHTML() {
			...
			html2canvas($(".html-content")[0]).then(function (canvas) {
				...
				pdf.addImage(imgData, 'PNG', top_left_margin, top_left_margin, canvas_image_width, canvas_image_height, '', 'FAST');
